...
- 🇫🇷 Paul R., Elder L. : _Le petit guide de la pensée critique : concepts et instruments_ &mdash; Foundation for Critical Thinking (traduction française du même guide)

<!--t src=9d51aaad-->
- 🇬🇧 David Hitchcock : [_Critical Thinking_](https://plato.stanford.edu/entries/critical-thinking), dans : Edward N. Zalta (dir.) : [Stanford Encyclopedia of Philosophy](https://plato.stanford.edu).

<!--t src=40abd020-->
- 🇬🇧 Jamie Carlin Watson : [_Critical Thinking_](https://iep.utm.edu/critical-thinking). Dans : James Fieser, Bradley Dowden (dir.) : [Internet Encyclopedia of Philosophy](https://iep.utm.edu).

<!--t src=4c261fc8-->
- 🇫🇷 [_Esprit critique_](https://fr.wikipedia.org/wiki/Esprit_critique) &mdash; sur fr.wikipedia.org
- 🇩🇪 [_Kritisches Denken_](https://de.wikipedia.org/wiki/Kritisches_Denken) &mdash; sur de.wikipedia.org
- 🇬🇧 [_Critical Thinking_](https://en.wikipedia.org/wiki/Critical_thinking) : sur en.wikipedia.org

<!--t src=b6e7cf0b-->
- 🇩🇪 Dorota Gierszewski : [_Die Kraft des kritischen Denkens. Sind Fähigkeiten wichtiger als Wissen?_](https://epale.ec.europa.eu/de/blog/die-kraft-des-kritischen-denkens-sind-faehigkeiten-wichtiger-als-wissen) &mdash; Epale, Commission européenne
...
- 🇩🇪 [Kritisches Denken in Zeiten von Fake News und halluzinierender Künstlicher Intelligenz](https://blog.univie.ac.at/studium/kritisches-denken/) &mdash; université de Vienne
