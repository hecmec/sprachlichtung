...
<h3>Qu’est-ce que la science ?</h3>
...
<h3>Arguments causaux et explications causales</h3>
...
<h3>Les conditions d’une explication adéquate</h3>
...
<h3>Hypothèses et deux sortes de sciences</h3>
...
<h3>La méthode empirique inductive : huit étapes</h3>
...
1. **La situation** — une situation fait surgir un problème ou une question, théorique ou pratique.
2. **Formuler le problème** — préciser ce que l’on étudie et comment (par voie statistique, expérimentale, historique).
3. **L’observation** — observer et consigner les phénomènes pertinents. (Une inquiétude philosophique : la théorie et les présupposés déterminent souvent ce qui compte comme observable.)
4. **La réflexion** — dégager les régularités qui se dessinent et un **mécanisme causal** possible, en s’appuyant sur les **connaissances de fond**. Un mécanisme causal relie la cause à l’effet ; sans lui, les événements ne sont que des coïncidences.
5. **Formuler une hypothèse** — l’élément central, une conjecture éclairée. Cette étape est **abductive** (un saut au-delà des preuves disponibles) et recourt à l’**inférence à la meilleure explication**.
6. **Faire des prédictions** — si l’hypothèse est correcte, certaines choses doivent s’ensuivre (pas d’oxygène, pas de feu).
7. **Mener des expériences** — répéter et observer. Un événement prédit apporte une **confirmation possible**, non une preuve ; une prédiction démentie signifie que l’hypothèse est probablement fausse.
8. **Accepter ou rejeter l’hypothèse** — le jugement dépend de la constance des résultats. En gros : environ 90 % de réussite invite à la conserver, environ 60 % appelle une étude complémentaire, moins de 40 % environ incite à l’abandonner. Une hypothèse confirmée avec une probabilité élevée devient une **théorie** ; une théorie universellement confirmée devient une **loi scientifique**.
...
<h3>Vérification, falsification et une mise en garde logique</h3>
