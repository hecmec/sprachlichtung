...
<!--t src=687dbcde-->
Certains pensent que tous les bons arguments consistent essentiellement en des inférences logiques formelles ou des syllogismes. Mais quand on regarde de près, on s'aperçoit vite qu'argumenter n'a pas grand-chose à voir avec l'inférence logique formelle.
...
<!--t src=ae076d4a-->
**Exemple d'inférence formelle (syllogisme) :**
Prémisse 1 : Tous les A sont B.
Prémisse 2 : Tous les B sont C.
Conclusion : Tous les A sont C.

<!--t src=3b7f0252-->
Ce schéma d'argumentation est valide indépendamment du contenu spécifique. Peu importe ce que désignent A, B et C &mdash; la conclusion découle nécessairement des prémisses.
...
<!--t src=58dcf661-->
[Artikel auf Deutsch](/docs/kritisches-denken/020-was-ist-ein-gutes-argument/070-formales-vs-informelles-schliessen.md) | [Article in English](/i18n/en/docusaurus-plugin-content-docs/current/kritisches-denken/020-was-ist-ein-gutes-argument/070-formales-vs-informelles-schliessen.md)
