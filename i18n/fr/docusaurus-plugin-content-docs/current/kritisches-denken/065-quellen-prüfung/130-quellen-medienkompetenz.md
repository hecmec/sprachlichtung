...
description: "Liste complète des sources du chapitre sur l'éducation aux médias et la critique des sources : méthodes, désinformation, falsifications par l'IA, outils de vérification des faits et pour aller plus loin"
keywords:
  - sources
...
- 🇬🇧 SBCC Library : [SIFT & PICK](https://libguides.sbcc.edu/siftpick). Un guide de bibliothèque qui combine la méthode de vérification SIFT avec l'aide à la sélection PICK, montrant ainsi comment évaluer une source et la choisir de façon adaptée.
- 🇬🇧 Meriam Library, CSU Chico : [CRAAP-Test](https://library.csuchico.edu/help/source-or-information-good). La source du célèbre test CRAAP, une liste de contrôle pour évaluer la crédibilité d'une source (actualité, pertinence, autorité, exactitude, objectif).
...
- 🇬🇧 Eli Pariser : [Beware online filter bubbles (TED Talk)](https://www.ted.com/talks/eli_pariser_beware_online_filter_bubbles). La célèbre conférence qui a rendu populaire la notion même de « bulle de filtres », présentée ici comme point de départ historique du débat.
- 🇬🇧 Milli et al. : [Engagement, user satisfaction, and the amplification of divisive content (PNAS Nexus, 2025)](https://academic.oup.com/pnasnexus/article/4/3/pgaf062/8052060). Une étude récente qui montre comment les algorithmes, en optimisant l'engagement, amplifient les contenus clivants.
...
- 🇩🇪 CORRECTIV : [Faktencheck](https://correctiv.org/faktencheck/). La rubrique de vérification des faits d'un centre de recherche allemand reconnu, une référence centrale pour les affirmations vérifiées dans l'espace germanophone.
- 🇩🇪 ARD : [Faktenfinder (Tagesschau)](https://www.tagesschau.de/faktenfinder). Le service de vérification des faits de la Tagesschau, qui contrôle les fausses nouvelles actuellement en circulation.
- 🇬🇧 EUfactcheck : [Flowchart](https://eufactcheck.eu/about-us/eufactcheck-flowchart/). Un organigramme qui visualise étape par étape le processus de vérification des faits.
- 🇬🇧 CIVIX : [Ctrl-F: Find the Facts](https://ctrl-f.ca/fr/). Un programme d'apprentissage gratuit qui entraîne à la lecture latérale et à la vérification rapide en ligne.
- 🇬🇧 InVID/WeVerify : [Verification Plugin](https://www.invid-project.eu/tools-and-services/invid-verification-plugin/). Un outil de navigateur gratuit pour vérifier images et vidéos, par exemple par recherche d'image inversée et analyse des métadonnées.
...
- 🇩🇪 [Wikipedia:Gesichtete Versionen](https://de.wikipedia.org/wiki/Wikipedia:Gesichtete_Versionen). L'explication du système de « versions contrôlées » propre à la Wikipédia germanophone (la version francophone n'a pas d'équivalent direct).
- 🇫🇷 [Fiabilité de Wikipédia (avec l'étude Nature de 2005)](https://fr.wikipedia.org/wiki/Fiabilit%C3%A9_de_Wikip%C3%A9dia). Un article de synthèse sur la fiabilité de Wikipédia, qui établit, grâce à la célèbre étude de _Nature_, que Wikipédia est un bon point de départ, mais non un point d'arrivée.
