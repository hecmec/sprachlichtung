...
description: "Sources et lectures complémentaires sur les fondements de la logique : manuels en ligne librement accessibles et introductions de référence."
keywords:
  - logique
  - pensée critique
  - sources
...
- 🇩🇪 Wolfgang Detel : _Grundkurs Philosophie. Band 1: Logik._ Reclam. Une entrée en matière compacte et agréable à lire dans la logique formelle, dans le cadre d'un cours de philosophie générale.
- 🇩🇪 Ernst Tugendhat, Ursula Wolf : _Logisch-semantische Propädeutik._ Reclam. Un classique qui relie logique et analyse du langage, en plaçant au centre le rapport entre langue et forme logique.
...
- 🇩🇪 Horst Wessel : [_Logik_ (1998, cc-by-sa-4.0).](https://zenodo.org/records/18620514)
  - [Horst Wessel (1942-2019)](<https://de.wikipedia.org/wiki/Horst_Wessel_(Philosoph)>) était professeur de logique à l'université Humboldt de Berlin. Son manuel _Logik_ est un exposé systématique et complet de la logique classique et non classique, exigeant mais qui introduit la matière avec beaucoup de soin.
- 🇩🇪 André Fuhrmann : [_Vorlesungen über Philosophische Logik_. (cc-by-4.0)](https://www.logos-verlag.de/ebooks/OA/978-3-8325-5654-9.pdf)
  - André Fuhrmann est professeur de philosophie à l'université Goethe de Francfort, spécialisé en logique. Ses _Vorlesungen_ vont au-delà de la logique propositionnelle et des prédicats classique et traitent aussi de systèmes non classiques comme les logiques modales et conditionnelles : elles conviennent donc comme lecture d'approfondissement.
- 🇬🇧 Andrew Lavin : [Fundamentals of Logic](https://wisconsin.pressbooks.pub/logicfundamentals/). Un manuel en ligne libre (REL) très accessible, qui mène de l'analyse des arguments à la logique formelle et convient particulièrement bien comme point de départ.
...
<!--t src=9982b7e1-->
[Artikel auf Deutsch](/docs/kritisches-denken/030-grundlagen-der-logik/120-quellen-logik.md) | [Article in English](/i18n/en/docusaurus-plugin-content-docs/current/kritisches-denken/030-grundlagen-der-logik/120-quellen-logik.md)
