...
title: La pensée critique en bref
sidebar_position: 0
sidebar_label: La pensée critique en 5 min
description: L'essentiel de la pensée critique, le tout sur une seule page
keywords:
  - pensée critique
  - résumé
  - argumentation
...
<!--t src=cbcbff62-->
**La pensée critique** est une assurance-vie.

<!--t src=29db6db1-->
**La pensée critique** est une manière de ne pas foncer aveuglément dans le mur ni de sauter dans le précipice.

<!--t src=3daf2849-->
**La pensée critique** nous aide à nous assurer que nous avons de bonnes raisons pour tout ce que nous croyons ou pensons, avant d'agir.

<!--t src=28ae10ac-->
Ou, de façon un peu plus académique : **la pensée critique** désigne l'ensemble des compétences et des attitudes qui nous permettent de distinguer le savoir de l'opinion : de séparer le vrai du faux, les bonnes raisons des mauvaises, les arguments concluants des arguments spécieux, l'apparence de l'être.

<!--t src=19bd8d06-->
## Nous sommes des êtres qui agissent et devons décider en permanence
...
<!--t src=5bc7caff-->
En tant que personne qui **pense de façon critique**, vous **remettez en question** toutes les affirmations, opinions et convictions : les vôtres, celles de vos amis et de votre entourage, celles de l'État, des organisations et des entreprises… celles de tous ceux qui veulent vous dire ce qui est bon pour vous.

<!--t src=5e118ef1-->
Pour atteindre vos objectifs à court ou à long terme, vous devez prendre des **décisions bien informées**, pour vous, pour votre entourage et pour votre environnement.
...
<p class="text--center">**Agir** = **Désir** + **Savoir**</p>

&mdash; David Hume [^handeln]
:::

<!--t src=ec9c197c-->
[^handeln]: Hume explique que les actions sont motivées par nos désirs ou nos buts, et que le savoir nous aide à atteindre ces buts. « A Treatise of Human Nature », Livre II, partie 3, section 3, « Of the Influencing Motives of the Will » (1739&mdash;40).

<!--t src=820e2c0b-->
Chaque action, chaque décision que nous prenons repose sur deux questions fondamentales :

<!--t src=229ce2f5-->
1. **Où voulez-vous aller ? = Buts / Désirs**.  
...
<!--t src=3ced32ef-->
2. **Comment y parvenez-vous ? = Savoir**.  
   Le second aspect, c'est le savoir dont nous avons besoin pour atteindre nos buts. Vous avez besoin de connaître le monde.
...
<!--t src=be8b818d-->
Il n'existe pas de réponse universelle à ces questions, car elles dépendent de vos buts et de vos valeurs individuels.
Mais les philosophes y réfléchissent depuis des milliers d'années et ont élaboré quelques critères qui peuvent vous aider à prendre de « bonnes décisions ».
...
- **Clarté** : il vaut mieux formuler vos buts de façon explicite (prendre conscience de ses besoins, de ses désirs). Et pour le savoir relatif aux moyens aussi, la clarté est importante (que sais-je exactement, et que ne sais-je pas ?).
- **Proportionnalité** : nous devons souvent décider dans des situations où nous ne disposons pas de toutes les informations. C'est pourquoi la force de votre action devrait être proportionnelle à la force des raisons justifiées.
- **Révisabilité** : vous pouvez et vous devriez, à l'occasion, remettre en question aussi bien vos buts et vos convictions fondamentales que le savoir relatif aux moyens (face à de nouvelles preuves), afin de l'adapter à la réalité. Devenez capable de changer d'avis pour de bonnes raisons.
...
- Vous **ne remarquez pas** qui vous dirige : vous devenez une proie facile pour la manipulation et l'exploitation.

<!--t src=6757fc6a-->
Vous croyez ce qu'on vous dit.  
...
<!--t src=5b436385-->
- Vous pouvez **reconnaître** ce qui est vraiment bon pour vous, et pas seulement ce qu'on vous vend comme bon.
- Vous pouvez **choisir** ce que vous voulez, au lieu de vouloir ce que d'autres ont choisi pour vous.
- Vous pouvez **agir** comme vous le voulez : dans le cadre des lois et dans le respect des autres.
- Vous pouvez **douter** là où tout le monde est sûr, et **faire confiance** là où vous avez de bonnes raisons.
- Vous pouvez **changer d'avis** sans perdre la face.

<!--t src=829c3d56-->
Vous voyez le monde tel qu'il est, et non tel que d'autres vous le dépeignent.  
Vous suivez des raisons, non des chefs.  
Vous savez où vous allez, et pourquoi.

<!--t src=93eec829-->
:::info Citation
"_Les Lumières, c'est la sortie de l'homme hors de l'état de minorité dont il est lui-même responsable._"

&mdash; Emmanuel Kant : _Qu'est-ce que les Lumières ?_[^aufklärung]
:::
...
<p class="text--center">**Pensée critique** = **Correct** + **Critique** </p>
...
<!--t src=68922741-->
Si vous n'êtes pas sûr de maîtriser l'un ou l'autre, pas d'inquiétude : **les deux s'apprennent**.

<!--t src=9d0a23ca-->
Nous allons présenter brièvement ces deux aspects ci-dessous.

<!--t src=eeefa661-->
## Comment pensez-vous correctement ?

<!--t src=796c72ac-->
Pour commencer, vous pouvez vous demander : qu'est-ce que penser **correctement**, et puis-je l'apprendre ?
Vous pouvez bien sûr l'apprendre en vous entraînant à quelques compétences :
...
<!--t src=55a64fb7-->
Mais vous devriez maîtriser les **bases essentielles** de la logique, sinon, pour vous, ce sera du chinois.
...
<!--t src=d8afc3d5-->
Vous devez donc apprendre à comprendre **comment on argumente correctement** et comment les gens argumentent réellement.

<!--t src=7c914084-->
Vous devez comprendre **comment fonctionnent les bons arguments** et pourquoi les mauvais arguments sont défectueux.
...
<!--t src=431fa520-->
Je vous laisse décider à qui vous préférez faire confiance.
...
- **Le dilemme du tramway** : si vous actionnez un aiguillage, une personne meurt. Si vous ne faites rien, le train fonce dans un bus rempli d'enfants. Que faites-vous ?
...
<!--t src=3cdfa115-->
## Comment pensez-vous de manière critique ?
...
<!--t src=0b447901-->
- **Pas toujours** : cela ne veut pas dire que nous devrions toujours, partout et tout remettre en question. Oh non, surtout pas, vous en deviendriez fou.
- **Quand ça fait mal** : on ne peut pas remettre constamment en question des théories établies ou des valeurs enracinées dans votre culture.
...
flowchart LR
    ...
    C --> E[Critique]
    D --> G[Bien argumenter]
    D --> F[Penser logiquement]
    D --> H[Langage clair]
    D --> I[Vérifier les sources]
    D --> J[Reconnaître les raisonnements fallacieux]
    D --> K[Reconnaître les biais]
    D --> L[Paradoxes & dilemmes]
    E --> M[Autocritique]
    E --> N[Écouter]
    E --> N2[Ouverture]
    E --> O[Suspendre son jugement]
```
...
<!--t src=b8cc8b98-->
[Artikel auf Deutsch](/docs/kritisches-denken/000-kritisches-denken-kurzgesagt.md) | [Article in English](/i18n/en/docusaurus-plugin-content-docs/current/kritisches-denken/000-kritisches-denken-kurzgesagt.md)
