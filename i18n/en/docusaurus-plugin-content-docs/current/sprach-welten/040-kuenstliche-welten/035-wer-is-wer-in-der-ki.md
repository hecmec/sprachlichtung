...
sidebar_position: 5
description: A guide to the most important minds in artificial intelligence, from the statistical foundations through Turing and Weizenbaum to Hinton, LeCun and today's critics.
keywords:
  - Alan Turing
  - Joseph Weizenbaum
  - Geoffrey Hinton
...
- **Claude Shannon** founded information theory in 1948 and measured for the first time how much information a symbol carries.[^shannon] Without that concept there would be neither data compression nor language models.
...
<!--t src=23a2b4af-->
- **Joseph Weizenbaum** wrote ELIZA and was alarmed at how readily people credited a simple program with understanding. His warning was directed less at the capabilities of machines than at our willingness to leave decisions to them.[^weizenbaum]
- **Hubert Dreyfus** argued philosophically that human skill rests on bodily experience and therefore cannot be captured in rules.[^dreyfus]
- **John Searle** put forward the Chinese Room thought experiment in 1980: processing symbols correctly does not amount to understanding them.[^searle]
...
<!--t src=2e9840f7-->
- **Emily M. Bender** and **Timnit Gebru** described large language models as "stochastic parrots": systems that reproduce patterns of language without grasping meaning.[^parrots]
- **Joy Buolamwini** demonstrated that commercial face recognition fails dramatically more often for dark-skinned women.[^gendershades]
- **Kate Crawford** investigates the raw materials, energy and labour behind AI systems.[^crawford]
...
<!--t src=d3abd2fb-->
[Artikel auf Deutsch](/docs/sprach-welten/040-kuenstliche-welten/035-wer-is-wer-in-der-ki.md) | [Article en français](/i18n/fr/docusaurus-plugin-content-docs/current/sprach-welten/040-kuenstliche-welten/035-wer-is-wer-in-der-ki.md)
