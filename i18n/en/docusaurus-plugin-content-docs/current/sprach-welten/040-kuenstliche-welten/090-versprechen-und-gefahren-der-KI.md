...
sidebar_position: 9
description: Where artificial intelligence really helps today, what damage it is already doing and how catastrophic risks can be assessed without lapsing into apocalyptic gloom.
keywords:
  - Opportunities of AI
  - Risks of AI
  - AI ethics
...
<!--t src=95880160-->
**Biology and medicine.** A system from DeepMind predicts the three-dimensional structure of proteins, a task researchers had worked on for fifty years. The structures of more than 200 million proteins have been publicly available since then and are accelerating the search for medicines worldwide.[^alphafold] In imaging, systems detect tumours and retinal damage reliably enough to take some of the load off specialists.
...
<!--t src=d4609c73-->
**Automated decisions with an air of authority.** In the Netherlands a risk system used by the tax administration wrongly classified thousands of families as childcare benefit fraudsters, with ruinous demands for repayment; dual nationality was one of the risk features fed into it. The government resigned over it in 2021.[^toeslagen] This is not a slip but the pattern: a statistical model makes a statement about probabilities, and the administration treats it as proof.

<!--t src=f942c3c8-->
**Prejudice with a mathematical aura.** Systems learn from past decisions and carry their imbalances forward, but now in a form that is harder to argue against. In studies, face recognition failed many times more often for dark-skinned women than for light-skinned men.[^gendershades]
...
<!--t src=a1d76d62-->
**Energy and climate.** In 2024 data centres consumed around 1.5 percent of the world's electricity, with a clearly rising trend driven by AI.[^iea] On top of that comes cooling water, often in dry regions. The benefit may justify it, but the justification should be given per application rather than across the board.

<!--t src=0b83b5e8-->
**Invisible labour.** For a system to answer politely, people first had to view and label depictions of violence and abuse, frequently in the global South for the lowest of wages.[^clickwork]
...
<!--t src=38d44675-->
Alongside these stand scenarios with very large damage and very uncertain probability. They deserve sober consideration, neither derision nor panic. The international report on the state of AI safety places them thus: plausible, not established, and strongly dependent on which protective measures are taken.[^safetyreport]
...
<!--t src=68b2d9e7-->
[^clickwork]: Billy Perrigo: _Exclusive: OpenAI Used Kenyan Workers on Less Than $2 Per Hour to Make ChatGPT Less Toxic_, TIME, 18 January 2023.

<!--t src=77c40c1b-->
[^safetyreport]: Yoshua Bengio et al.: _International AI Safety Report_, 2025.

<!--t src=1be3d02c-->
[Artikel auf Deutsch](/docs/sprach-welten/040-kuenstliche-welten/090-versprechen-und-gefahren-der-KI.md) | [Article en français](/i18n/fr/docusaurus-plugin-content-docs/current/sprach-welten/040-kuenstliche-welten/090-versprechen-und-gefahren-der-KI.md)
