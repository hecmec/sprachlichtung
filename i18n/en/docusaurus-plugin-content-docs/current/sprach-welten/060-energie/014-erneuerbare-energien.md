...
title_meta: Renewable Energy
sidebar_label: Renewable Energy
sidebar_position: 14
description: What counts as renewable energy, and what share does it cover today?
keywords:
  - Renewable energy
  - Regenerative energy
  - Energy transition
...
> The fight is over who controls the wires, storage and profits in between.
...
## The trick with the percentages

<!--t src=9c6449f2-->

When the news says renewables cover "more than half," a critical follow-up question is worth asking: half of what? Almost always what is meant is **electricity**. But electricity is only one part of our hunger for energy. On top of it come **heat** (heating, hot water, industry) and **transport**, and there the renewable shares are to this day considerably smaller.[^uba-zahlen] Whoever confuses electricity with total energy either takes us to be further along than we are, or talks down the progress. On close inspection, advertising and reality part ways.
...
The most honest answer is given by the price. **Solar (photovoltaics)** and **wind** have become so cheap over the last fifteen years that today they are usually the cheapest way to generate new electricity, cheaper than new coal or nuclear plants.[^owid-energy] Both can be set up quickly and scaled at will, from the small house roof to the huge wind farm. Hydropower is strong but largely built out; biomass and geothermal play more of a supplementary role.
...
## What does the kilowatt-hour cost?

<!--t src=d2951d10-->

Numbers say more than opinions. The following table shows rough **levelized costs** for **new** installations, that is, what a generated kilowatt-hour (kWh) roughly costs when construction, operation and financing are spread over the lifetime (here simplified to about 20 years). The values are rules of thumb in **cents per kWh** and vary greatly depending on location, size, interest rates and weather.[^kosten]

<!--t src=70fa4765-->

| Energy form                               | Electricity or heat | ≈ Cost (ct/kWh) | Note                                           |
| ----------------------------------------- | ------------------- | --------------- | ---------------------------------------------- |
| Solar electricity, open field             | Electricity         | 4–7             | currently often the cheapest source of power   |
| Solar electricity, house roof             | Electricity         | 7–12            | smaller, but power right where it is used      |
| Solar heat (solar thermal)                | Heat                | 6–12            | for hot water and heating support              |
| Wind power on land (onshore)              | Electricity         | 4–9             | strongly dependent on location                 |
| Wind power at sea (offshore)              | Electricity         | 7–12            | high yield, but costly to build                |
| Hydropower                                | Electricity         | 5–15            | existing plants very cheap, new build costly   |
| Biomass / biogas                          | Electricity         | 10–20           | controllable on demand, but costly and limited |
| Geothermal, near-surface (heat pump)      | Heat                | 8–15            | depends on the pump's electricity price        |
| Geothermal, deep (deep geothermal)        | Heat                | 4–10            | high upfront costs, drilling risk              |
| Geothermal, deep (electricity generation) | Electricity         | 15–30           | economical only at favourable sites            |
...
[^kosten]: Orders of magnitude following Fraunhofer ISE: "Levelized Cost of Electricity - Renewable Energy Technologies," [ise.fraunhofer.de](https://www.ise.fraunhofer.de/) (regularly updated study). Heat costs depending on installation and energy price; all values are rounded ranges for orientation, not exact quotes.

<!--t src=6acdea41-->

[^uba-zahlen]: German Environment Agency (Umweltbundesamt): "Renewable energies in figures," [umweltbundesamt.de/themen/klima-energie/erneuerbare-energien/erneuerbare-energien-in-zahlen](https://www.umweltbundesamt.de/themen/klima-energie/erneuerbare-energien/erneuerbare-energien-in-zahlen). Current values for electricity, heat and transport reported separately.
...
[Artikel auf Deutsch](/docs/sprach-welten/060-energie/014-erneuerbare-energien.md) | [Article en français](/fr/docs/sprach-welten/060-energie/014-erneuerbare-energien.md)
