---
title: Introduction to Language Games
sidebar_label: Introduction
sidebar_position: 1
description: Introduction to language games
keywords:
  - Language games
  - Word meaning
  - Use
...
- **Rules/features:**
  ...
  - **Logical consistency:** Arguments must not contradict one another.
  - **Falsifiability:** A statement must be formulated so that it could in principle be refuted.
...
- **Rules/features:**
  ...
  - **Formal procedures:** Clear processes and roles (judge, lawyer, witness).
  - **Binary logic:** Often it is about decisions like "guilty/not guilty" or "lawful/unlawful".
- **Examples:**
  - "Pursuant to Section 823 of the German Civil Code (BGB), the defendant is liable for damages." (Application of a rule)
  - "I plead not guilty." (A formal move in a criminal trial)
...
- **Rules/features:**
  ...
  - **Appeal to values:** Terms like "freedom", "security", "justice" are deployed strategically.
  - **Compromise and negotiation:** The result is often not "right" or "wrong" but a negotiated compromise. Some have lately taken to calling this a "deal".
- **Examples:**
  - "We need a strong economy to secure our prosperity." (An appeal to a shared value)
  - A campaign speech that discredits the political opponent.
...
- **Rules/features:**
  ...
  - **Unspoken rules:** Politeness, irony, small talk.
  - **Relationship level:** Every statement also carries information about the relationship of the speakers.
- **Examples:**
  - The greeting: "How are you?" (The expected answer is often a set phrase, not a detailed analysis.)
  - Telling a joke.
...
- **Rules/features:**
  ...
  - **Metaphors and symbols:** Language is used not literally but figuratively.
  - **Breaking rules:** Art often deliberately breaks the rules of other language games (e.g. of logic or of everyday language).
- **Examples:**
  - A poem that creates a mood through its melody of sound and choice of words.
  - An art review that interprets a work ("The dark colours reflect the artist's despair.").
...
- **What is the goal of this game?**
  - Truth, fame, being right
  - Power, the production of social justice
  - social glue, inspiration or education
- **By what rules is it played?**
  - explicit rules,
  - implicit rules,
- **Is it played fairly, or is someone trying to apply the rules of one game in another arena?**
  - e.g. a scientific question like "Is there a difference between biological and social sex/gender?" is in many countries to this day simply "decided" with legal and political arguments.
...
<!--t src=05ed0fff-->
[Artikel auf Deutsch](/docs/sprach-welten/020-sprachspiele/010-einfuehrung-in-sprachspiele.md) | [Article en français](/i18n/fr/docusaurus-plugin-content-docs/current/sprach-welten/020-sprachspiele/010-einfuehrung-in-sprachspiele.md)
