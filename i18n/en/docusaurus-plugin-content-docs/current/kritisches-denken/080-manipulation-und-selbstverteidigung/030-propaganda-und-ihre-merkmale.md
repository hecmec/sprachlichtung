...
1. **Oversimplification of complex matters**: Complex topics are reduced to simple slogans or images.

<!--t src=7275a3a6-->
   _Example_: "Make America Great Again" &mdash; a simple slogan that reduces complex political and economic questions to a nostalgic formula.

<!--t src=6673ab98-->

2. **Emotionalisation**: Feelings are appealed to in order to bypass rational thinking.

<!--t src=8e3fb037-->
   _Example_: War propaganda that arouses fear of the enemy and patriotic feelings.

<!--t src=0654aee4-->

3. **Repetition**: Messages are repeated constantly in order to anchor them in memory.

<!--t src=9bb0f182-->
   _Example_: The continual repetition of party slogans in election campaigns.

<!--t src=5efd8bd4-->

4. **Construction of an enemy image**: A clear enemy image is created against which people can be mobilised.

<!--t src=ae8f874e-->
   _Example_: Portraying political opponents as "enemies of the people" or "traitors".

<!--t src=8c37dfae-->

5. **Appeal to authority**: Respected figures or institutions are invoked for support.

<!--t src=0a132c84-->
   _Example_: "Leading scientists support our position."

<!--t src=9f3b3269-->

6. **Selective choice of facts**: Only information that supports one's own position is presented.

<!--t src=4e8538c5-->
   _Example_: Statistical data are selectively chosen in order to "prove" economic success or failure.

<!--t src=8bb62661-->

7. **Peer pressure**: It is suggested that "everyone" or "the majority" shares a particular opinion.

<!--t src=020003f6-->
   _Example_: "The silent majority stands behind us."
