...
sidebar_position: 60
description: Distinction between validity and soundness of arguments with examples for evaluating logical conclusions.
keywords:
  - validity
  - soundness
  - logical form
...
_or, put differently_

If all premises are true, then the conclusion cannot be false.
:::

<!--t src=3c93250c-->
Validity refers exclusively to the logical form of the argument, not to the truth content of the premises.
