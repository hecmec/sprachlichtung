...
description: "Sources and further reading on the fundamentals of logic: freely available online textbooks and standard German-language introductions."
keywords:
  - logic
  - critical thinking
  - sources
...
- 🇩🇪 Horst Wessel: [_Logik_ (1998, cc-by-sa-4.0).](https://zenodo.org/records/18620514)
  - [Horst Wessel (1942–2019)](<https://de.wikipedia.org/wiki/Horst_Wessel_(Philosoph)>) was professor of logic at the Humboldt University of Berlin. His textbook _Logik_ is a comprehensive, systematic account of classical and non-classical logic; demanding, but a thorough introduction to the subject.
- 🇩🇪 André Fuhrmann: [_Vorlesungen über Philosophische Logik_. (cc-by-4.0)](https://www.logos-verlag.de/ebooks/OA/978-3-8325-5654-9.pdf)
  - André Fuhrmann is professor of philosophy at the Goethe University Frankfurt, specialising in logic. His _Vorlesungen_ go beyond classical propositional and predicate logic and also cover non-classical systems such as modal and conditional logic, which makes them suitable as further reading.
- 🇬🇧 Andrew Lavin: [Fundamentals of Logic](https://wisconsin.pressbooks.pub/logicfundamentals/). A very accessible, freely licensed online textbook (OER) that leads from argument analysis to formal logic and is particularly well suited as a starting point.
...
[Artikel auf Deutsch](pathname:///docs/kritisches-denken/grundlagen-der-logik/quellen-logik) | [Article en français](pathname:///fr/docs/kritisches-denken/grundlagen-der-logik/quellen-logik)
