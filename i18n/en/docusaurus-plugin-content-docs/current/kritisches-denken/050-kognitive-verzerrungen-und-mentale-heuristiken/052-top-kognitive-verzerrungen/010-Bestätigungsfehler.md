...
sidebar_position: 1
description: Confirmation bias is the tendency to search for, interpret, and recall information in a way that confirms our existing beliefs.
keywords:
  - cognitive biases
  - mental heuristics
  - biases
...
_You only hear what you want to hear._
:::
...
- Apply the "steelman" method[^1]: formulate opposing arguments as strongly as possible
- Ask others for critical feedback
- Formulate hypotheses that could disprove your own beliefs

<!--t src=c2ea60c9-->
[^1]: The steelman method is a technique in which you formulate your opponent's arguments as strongly and convincingly as possible before refuting them. It is the opposite of the straw man argument.
