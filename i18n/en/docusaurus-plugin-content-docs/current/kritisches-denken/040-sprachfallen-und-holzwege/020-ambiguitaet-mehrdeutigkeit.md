...
title: Ambiguity
sidebar_position: 2
description: Explanation of different types of ambiguity in language and their impact on critical thinking
keywords:
  - ambiguity
  - lexical ambiguity
  - syntactic ambiguity
...
- "Pen" can refer to a writing instrument or an enclosure for animals.
- "Horse" can refer to an animal or a piece of gymnastic equipment.

<!--t src=63520f65-->

**Example of a fallacy due to lexical ambiguity:**
"A bank is a safe place to keep your money. The side of the river is a bank. Therefore, the side of the river is a safe place to keep your money."
...
1. **Identify potential ambiguities**: Pay attention to words or sentences that could allow for different interpretations.

<!--t src=f0334553-->

2. **Clarify terms**: Ask for definitions or provide them yourself to avoid misunderstandings.

<!--t src=496036b2-->

3. **Rephrase statements**: Express ambiguous statements in clearer language.

<!--t src=6defd86e-->

4. **Context analysis**: Consider the context to determine the most likely meaning.
