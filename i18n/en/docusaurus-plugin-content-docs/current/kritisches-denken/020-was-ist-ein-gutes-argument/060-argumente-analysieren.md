...
sidebar_position: 6
description: Methods for analyzing arguments
keywords:
  - value assumptions
  - factual assumptions
  - argument analysis
...
_Hidden assumption_: Women have natural characteristics that make them good nurses.
...
**Example**: "The crime rate has dropped since we got the new chief of police."
_Hidden assumption_: The new chief of police is the cause of the drop in crime.
...
2. **Negation test**: Negate the suspected assumption and check whether the argument still makes sense.
...
3. **Change of perspective**: Consider the argument from different cultural, historical, or ideological perspectives.
...
4. **Analogy check**: Construct an analogy to the argument and check whether it is similarly convincing.
...
2. It helps to uncover problematic or unfounded assumptions that can undermine the strength of an argument.
