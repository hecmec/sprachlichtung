...
<!--t src=2c1fc05d-->
1. **Empirical orientation**: Basing decisions on observations and evidence rather than on assumptions or beliefs.

<!--t src=9e6ada64-->
   *Example*: When choosing a diet, looking for scientific studies rather than anecdotes or testimonials.

<!--t src=8717763c-->
2. **Hypothesis testing**: Regarding assumptions as hypotheses and testing them systematically.
...
<!--t src=3f5611fb-->
3. **Control of variables**: Keeping as many factors as possible constant when making comparisons or tests.

<!--t src=5c85f513-->
   *Example*: When testing a new product, keeping all other factors (frequency of use, environment, etc.) the same.

<!--t src=d8f79a83-->
4. **Systematic data collection**: Gathering information methodically and completely.

<!--t src=536106ac-->
   *Example*: In the case of health symptoms, keeping a diary that documents all relevant factors (diet, activity, sleep, etc.).

<!--t src=c69ed437-->
5. **Critical evaluation of evidence**: Evaluating information with regard to quality, relevance and reliability.
...
<!--t src=7c24dec8-->
1. **Confirmation bias**: Actively looking for information that contradicts one's own beliefs.

<!--t src=73572d2c-->
   *Strategy*: When researching, deliberately looking for contrary arguments or evidence.

<!--t src=5935f284-->
2. **Availability heuristic**: Using systematic data instead of easily available examples.

<!--t src=b4031894-->
   *Strategy*: When assessing risks, looking for statistical data rather than anecdotal reports.

<!--t src=b7f51e3d-->
3. **Anchoring effect**: Deliberately considering different reference points.

<!--t src=f59370f0-->
   *Strategy*: In negotiations or price assessments, drawing on several independent comparison values.

<!--t src=3a32d47f-->
4. **Fundamental attribution error**: Taking situational factors into account when explaining behaviour.

<!--t src=2c58fe76-->
   *Strategy*: When judging the behaviour of others, systematically asking about contextual influences.

<!--t src=96549e94-->
5. **Hindsight bias**: Documenting predictions before events occur.
