...
1. Submission: Researchers submit their work to a scientific journal.
2. Editorial pre-screening: An editor checks whether the work meets basic criteria.
3. Review: The work is sent to several independent experts (peers).
4. Evaluation: The reviewers assess the work with regard to methodology, results, interpretation and significance.
5. Decision: Based on the reviews, the editor decides on acceptance, revision or rejection.
6. Revision: If necessary, the authors revise their work in accordance with the reviewers' comments.
7. Publication: After acceptance, the work is published.
...
In recent years, various disciplines, particularly psychology and biomedicine, have experienced a "replication crisis", in which many published results could not be replicated.
