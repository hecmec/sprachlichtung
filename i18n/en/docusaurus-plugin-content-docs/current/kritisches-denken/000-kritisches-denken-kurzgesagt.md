...
<!--t src=4d6e66bd by="Immanuel Lupinus" on=2026-09-17-->

Literally, emancipation means: to be released from the hand [^emanzipation]. In other words: no longer a slave, no longer a child who is not of age.
...
flowchart LR
    ...
    C --> D[Correct]
    C --> E[Critical]
    D --> G[Arguing Correctly]
    D --> F[Thinking Logically]
    D --> H[Clear Language]
    D --> I[Checking Sources]
    D --> J[Recognising Fallacies]
    D --> K[Recognising Biases]
    D --> L[Paradoxes & Dilemmas]
    E --> M[Self-Criticism]
    E --> N[Listening]
    E --> N2[Open-mindedness]
    E --> O[Suspending Judgement]
```
...
<!--t src=b8cc8b98-->
[Artikel auf Deutsch](/docs/kritisches-denken/000-kritisches-denken-kurzgesagt.md) | [Article en français](/i18n/fr/docusaurus-plugin-content-docs/current/kritisches-denken/000-kritisches-denken-kurzgesagt.md)
