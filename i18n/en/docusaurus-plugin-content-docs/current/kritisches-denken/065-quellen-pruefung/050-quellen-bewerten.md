...
<!--t src=6594fe57-->
### 2. Expertise: _Does the person actually know about this?_
...
<!--t src=c1a62388-->
### 3. Reputation: _What is the source's reputation?_
...
<!--t src=9f91de8e-->
### 4. Currency: _Is the information still up to date?_
...
<!--t src=0af3fe6b-->
### 6. Evidence: _What supports this?_
...
<!--t src=344aa255-->
## The benefit question: _Cui bono?_

<!--t src=bd988883-->
A single question bundles much of this: **Who benefits from this information?** (_Cui bono_ = to whose advantage?)  
...
<!--t src=40c36dce-->
- **C**urrency: how up to date it is
- **R**elevance: relevance to your own topic
- **A**uthority: authorship/authority
- **A**ccuracy: accuracy/evidence
- **P**urpose: purpose/intent

<!--t src=3edd6e92-->
Source: Meriam Library, CSU Chico ([CRAAP test](https://library.csuchico.edu/help/source-or-information-good)).
...
<!--t src=b8ebaaa0-->
Once credibility is settled, **PICK** helps with the question of whether the source is the right one for _your purpose_:

<!--t src=9d4c5cd7-->
- **P**urpose: what kind of source is this, and does the genre fit my question?
- **I**nformation: is the content relevant and useful to me?
- **C**reation date: is it recent enough?
- **K**nowledge-building: does it really advance my understanding?
...
<!--t src=ebc93104-->
:::tip In short
**SIFT** settles: _Can I trust the source?_ **PICK** settles: _Is it the right one for my task?_
:::
