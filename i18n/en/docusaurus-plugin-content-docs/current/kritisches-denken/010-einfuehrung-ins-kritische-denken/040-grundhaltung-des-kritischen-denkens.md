...
<!--t src=8a015b29-->
As an alternative to humility, the basic attitude of critical thinking can also be summed up as **prudence**.  
In Greek philosophy (e.g. in Aristotle), sophrosyne (prudence, temperance, Greek σωφροσύνη) was regarded as a virtue related to humility &mdash; a balance between overestimating oneself and submissiveness.
...
The basic attitude of critical thinking can perhaps be summed up with the term **prudence**.
In Greek philosophy (e.g. in Aristotle), sophrosyne (prudence, temperance, Greek σωφροσύνη) was regarded as a virtue related to humility &mdash; a balance between overestimating oneself and submissiveness.
