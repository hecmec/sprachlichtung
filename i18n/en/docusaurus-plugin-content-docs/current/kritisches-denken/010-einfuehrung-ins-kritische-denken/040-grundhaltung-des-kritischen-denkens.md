...
As an alternative to humility, the fundamental attitude of critical thinking can also be summed up as **prudence**.
In Greek philosophy (e.g. in Aristotle), sophrosyne (prudence, Greek σωφροσύνη) was regarded as a virtue related to humility &mdash; a balance between overestimating oneself and submissiveness.
...
The fundamental attitude of critical thinking can perhaps be summed up with the concept of **prudence**.
In Greek philosophy (e.g. in Aristotle), sophrosyne (prudence, Greek σωφροσύνη) was regarded as a virtue related to humility &mdash; a balance between overestimating oneself and submissiveness.
