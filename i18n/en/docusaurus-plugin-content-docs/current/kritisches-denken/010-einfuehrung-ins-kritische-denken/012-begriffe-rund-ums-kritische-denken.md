---
title: Important Terms in Critical Thinking
sidebar_label: Important Terms
sidebar_position: 12
description: An introduction to the ability to think reflectively, independently and rationally and to analyse information systematically.
keywords:
  - critical thinking
  - important terms
  - argumentation
...
_The toolkit: what an argument is made of and what makes it a good one._
...
[Wikipedia](https://en.wikipedia.org/wiki/Justification_%28epistemology%29)
...
Inference from the particular to the general: from observations a general rule is conjectured &mdash; probable, but not necessarily true.
...
[Wikipedia](https://en.wikipedia.org/wiki/Validity_%28logic%29)
...
[Wikipedia](https://en.wikipedia.org/wiki/Relevance)
...
[Wikipedia](https://en.wikipedia.org/wiki/Coherentism)
...
[Wikipedia](https://en.wikipedia.org/wiki/Consistency)

<!--t src=d48be3e4-->

### Judgment (in the logical sense)
...
[Wikipedia](https://en.wikipedia.org/wiki/Judgment_%28mathematical_logic%29)
...
[Wikipedia](https://en.wikipedia.org/wiki/Normativity)
...
[Wikipedia](https://en.wikipedia.org/wiki/Informal_logic)
...
_Basic concepts around knowledge, truth and personal opinion._
...
[Wikipedia](https://en.wikipedia.org/wiki/Objectivity_%28philosophy%29)
...
_Typical errors in thinking and in arguments &mdash; you can only avoid them once you know them._
...
An inference whose form is invalid, so that the conclusion does not necessarily follow from the premises &mdash; regardless of the content.
...
Something is held to be true merely because an authority says so &mdash; without checking that authority's competence or the evidence.
...
[Wikipedia](https://en.wikipedia.org/wiki/Circular_reasoning)
...
Only two options are presented although others exist &mdash; black-and-white thinking that forces a pseudo-decision.
...
That two things occur together (correlation) does not mean that one causes the other (causation) &mdash; a common fallacy.

<!--t src=31446d43-->

[Wikipedia](https://en.wikipedia.org/wiki/Spurious_relationship)

<!--t src=47e5fa1f-->

## Lies, Bullshit and Disinformation

<!--t src=98cfe6f2-->

_Forms of deception and influence that critical thinking is meant to protect against._
...
[Wikipedia](https://en.wikipedia.org/wiki/Agitprop)
...
[Wikipedia](https://en.wikipedia.org/wiki/Indoctrination)
...
[Wikipedia](https://en.wikipedia.org/wiki/On_Bullshit)
...
[Wikipedia](https://en.wikipedia.org/wiki/Manipulation_%28psychology%29)
...
[Wikipedia](https://en.wikipedia.org/wiki/Framing_effect_%28psychology%29)
...
[Wikipedia](https://en.wikipedia.org/wiki/Cherry_picking)
...
_Attitudes and methods that put good thinking into practice._
...
Latin for "Dare to be wise!" &mdash; Kant's motto of the Enlightenment: have the courage to use your own understanding.
...
[Wikipedia](https://en.wikipedia.org/wiki/Reflection_%28philosophy%29)
...
[Wikipedia](https://en.wikipedia.org/wiki/Zététique)
...
[Wikipedia](https://en.wikipedia.org/wiki/Source_criticism)
...
A rule of thumb or simplified procedure that, with limited knowledge, quickly leads to usable solutions &mdash; useful, but error-prone.
...
[Wikipedia](https://en.wikipedia.org/wiki/Falsifiability)
...
_Inner attitudes that make critical thinking possible in the first place._
...
[Wikipedia](https://en.wikipedia.org/wiki/Perspective-taking)
...
Rigidly clinging to doctrines that are regarded as incontrovertible and may not be questioned &mdash; the opposite of critical openness.
