...
sidebar_position: 1
description: Description of the post hoc fallacy (temporal succession confused with cause)
keywords:
  - fallacies
  - critical thinking
...
:::tip In brief
Because B followed A, A is taken to be the cause of B.

_After it does not mean because of it._
:::
...
2. Therefore A caused event B.

<!--t src=7ec66ba8-->

Also known as: _post hoc ergo propter hoc_ / _false cause_
...
The temporal succession is no evidence of a cause. The rise can have quite different reasons.
...
That the passing followed does not make the lucky charm its cause. Here it was the studying that worked, not the talisman.
...
[Artikel auf Deutsch](pathname:///docs/kritisches-denken/fehlschluesse-und-schlechtes-argumentieren/liste-informeller-fehlschluesse/post-hoc-ergo-propter-hoc) | [Article en français](pathname:///fr/docs/kritisches-denken/fehlschluesse-und-schlechtes-argumentieren/liste-informeller-fehlschluesse/post-hoc-ergo-propter-hoc)
