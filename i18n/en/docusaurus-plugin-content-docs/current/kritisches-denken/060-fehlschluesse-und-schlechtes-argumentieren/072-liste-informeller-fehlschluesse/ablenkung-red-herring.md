---
title: Red Herring
title_meta: Red Herring
sidebar_label: Red Herring
sidebar_position: 1
description: Description of the red herring (distraction from the actual topic)
keywords:
  - fallacies
  - critical thinking
  - red herring
...
:::tip In brief
Attention is diverted from the actual topic to an irrelevant side issue.

_Laying a false trail._
:::
...
The error: the side issue may be important in itself, but it has nothing to do with the original question. It is used to dodge an answer.
...
1. Topic A is up for debate.
2. Instead of A, the distracting topic B is introduced.
3. Attention shifts to B; A remains unanswered.

<!--t src=51b22578-->

Also known as: _red herring_
...
The achievement of building it up is not the question. It distracts from the actual question about the doctored figures.
...
The reference to China does not answer the question about waste sorting but evades it.
...
<!--t src=edad2da6-->
[Artikel auf Deutsch](/docs/kritisches-denken/060-fehlschluesse-und-schlechtes-argumentieren/072-liste-informeller-fehlschluesse/ablenkung-red-herring.md) | [Article en français](/i18n/fr/docusaurus-plugin-content-docs/current/kritisches-denken/060-fehlschluesse-und-schlechtes-argumentieren/072-liste-informeller-fehlschluesse/ablenkung-red-herring.md)
