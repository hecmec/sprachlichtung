...
title_meta: Personal Incredulity
sidebar_label: Personal Incredulity
sidebar_position: 1
description: Description of the argument from personal incredulity
keywords:
  - fallacies
  - critical thinking
...
:::tip In brief
„I can't imagine that, so it isn't true.“

_The limits of one's own imagination are not the limits of reality._
:::
...
1. I cannot imagine / explain B.
2. Therefore B is false (or: therefore the alternative that is obvious to me must be true).

<!--t src=e14aadf5-->

Also known as: _argument from incredulity_ / _personal incredulity_
...
The difficulty of imagining a process says nothing about whether it took place.
...
From one's own inability to imagine the technique, no extraterrestrial explanation follows.
...
[Artikel auf Deutsch](pathname:///docs/kritisches-denken/fehlschluesse-und-schlechtes-argumentieren/liste-informeller-fehlschluesse/persoenliche-skepsis) | [Article en français](pathname:///fr/docs/kritisches-denken/fehlschluesse-und-schlechtes-argumentieren/liste-informeller-fehlschluesse/persoenliche-skepsis)
