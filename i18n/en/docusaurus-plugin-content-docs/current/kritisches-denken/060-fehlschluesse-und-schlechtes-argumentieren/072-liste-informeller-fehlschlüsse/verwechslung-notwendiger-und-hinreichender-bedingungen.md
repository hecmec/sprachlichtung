---
title: Confusing Necessary and Sufficient Conditions
title_meta: Necessary and Sufficient Conditions
sidebar_label: Necessary vs. Sufficient Conditions
sidebar_position: 1
description: Description of the confusion of necessary and sufficient conditions
keywords:
  - fallacies
  - critical thinking
  - necessary condition
...
2. A is present.
3. Therefore B occurs. (inadmissible: A is not enough)

<!--t src=c240f4f7-->

In propositional logic this corresponds to **affirming the consequent** or the **converse error**.

<!--t src=70ada299-->

Also known as: _confusing necessary and sufficient conditions_
...
Even if money were a necessary condition, it would not be enough. The necessary condition is confused with a sufficient one.
