---
title: Wer ist wer in der KI
title_meta: "Wer ist wer in der KI: die wichtigsten Köpfe von Bayes bis heute"
sidebar_label: Wer ist wer in der KI
sidebar_position: 5
description: "Eine Orientierung über die wichtigsten Köpfe der künstlichen Intelligenz, von den statistischen Grundlagen über Turing und Weizenbaum bis zu Hinton, LeCun und den heutigen Kritikerinnen und Kritikern."
keywords:
  - Alan Turing
  - Joseph Weizenbaum
  - Geoffrey Hinton
...
- **Claude Shannon** begründete 1948 die Informationstheorie und maß erstmals, wie viel Information in einem Zeichen steckt.[^shannon] Ohne diesen Begriff gäbe es weder Datenkompression noch Sprachmodelle.
...
- **Joseph Weizenbaum** schrieb ELIZA und erschrak darüber, wie bereitwillig Menschen einem simplen Programm Verständnis unterstellten. Seine Warnung galt weniger den Fähigkeiten der Maschinen als der Bereitschaft, ihnen Entscheidungen zu überlassen.[^weizenbaum]
- **Hubert Dreyfus** argumentierte philosophisch, dass menschliches Können auf leiblicher Erfahrung beruht und sich deshalb nicht in Regeln fassen lässt.[^dreyfus]
- **John Searle** stellte 1980 das Gedankenexperiment des Chinesischen Zimmers auf: Symbole korrekt zu verarbeiten heißt nicht, sie zu verstehen.[^searle]
...
- **Emily M. Bender** und **Timnit Gebru** beschrieben große Sprachmodelle als "stochastische Papageien": als Systeme, die Sprachmuster wiedergeben, ohne Bedeutung zu erfassen.[^parrots]
- **Joy Buolamwini** wies nach, dass kommerzielle Gesichtserkennung bei dunkelhäutigen Frauen dramatisch häufiger versagt.[^gendershades]
- **Kate Crawford** untersucht, welche Rohstoffe, Energie und Arbeit hinter KI-Systemen stecken.[^crawford]
...
[^weizenbaum]: Joseph Weizenbaum: _Die Macht der Computer und die Ohnmacht der Vernunft_, Suhrkamp, 1977.
...
[Article en français](pathname:///fr/docs/sprach-welten/kuenstliche-welten/wer-is-wer-in-der-ki) | [Article in English](pathname:///en/docs/sprach-welten/kuenstliche-welten/wer-is-wer-in-der-ki)
