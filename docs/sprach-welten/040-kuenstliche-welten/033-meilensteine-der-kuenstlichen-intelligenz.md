---
title: Meilensteine der künstlichen Intelligenz
title_meta: "Meilensteine der künstlichen Intelligenz: elf Stationen von 1950 bis heute"
sidebar_label: Meilensteine der KI
sidebar_position: 4
description: "Elf historische Meilensteine der künstlichen Intelligenz, von Turings Testfrage über die KI-Winter bis zu Transformern und Sprachmodellen."
keywords:
  - Meilensteine
  - Geschichte der KI
  - Turing-Test
...
Statt zu fragen, ob Maschinen denken können, fragt Alan Turing, ob eine Maschine ein Gespräch so führen kann, dass ein Mensch sie nicht von einem Menschen unterscheidet.[^turing] Die Frage nach dem Innenleben wird ersetzt durch eine Frage nach dem Verhalten. Dieser Kunstgriff prägt die Debatte bis heute.
...
Joseph Weizenbaum programmiert einen Chatbot, der einen Psychotherapeuten imitiert, indem er Aussagen als Fragen zurückspiegelt. Das Programm ist wenige Seiten lang und versteht nichts. Trotzdem vertrauen ihm Testpersonen Persönliches an. Weizenbaum erschrickt darüber so sehr, dass er zum bekanntesten Kritiker des Fachs wird.[^weizenbaum]

## Die Ernüchterung

### 1969: Die Grenzen des Perzeptrons

Marvin Minsky und Seymour Papert zeigen mathematisch, was einfache Perzeptronen prinzipiell nicht lernen können.[^minsky] Die Forschungsgelder versiegen, das Feld stürzt in den ersten "KI-Winter". Ein zweiter folgt in den späten 1980er Jahren, als die teuren Expertensysteme der Industrie ihre Versprechen nicht halten.

### 1986: Netze lernen in der Tiefe

David Rumelhart, Geoffrey Hinton und Ronald Williams machen ein Verfahren populär, mit dem sich auch vielschichtige Netze trainieren lassen: die Fehlerrückführung.[^backprop] Damit ist Minskys Einwand technisch beantwortet. Nur fehlen noch Daten und Rechenleistung, um es zu zeigen. Es dauert 26 Jahre.
...
Eine Forschergruppe bei Google stellt eine neue Netzarchitektur vor, die Wortbeziehungen über ganze Texte hinweg parallel verarbeitet.[^transformer] Sie ist die technische Grundlage praktisch aller heutigen Sprachmodelle. Der Aufsatz gehört zu den meistzitierten der Informatik.
...
[^turing]: Alan M. Turing: _Computing Machinery and Intelligence_, Mind 59, 1950.

[^weizenbaum]: Joseph Weizenbaum: _Die Macht der Computer und die Ohnmacht der Vernunft_, Suhrkamp, 1977 (englisch: _Computer Power and Human Reason_, 1976).

[^minsky]: Marvin Minsky, Seymour Papert: _Perceptrons: An Introduction to Computational Geometry_, MIT Press, 1969.
...
[Article en français](/fr/docs/sprach-welten/040-kuenstliche-welten/033-meilensteine-der-kuenstlichen-intelligenz.md) | [Article in English](/en/docs/sprach-welten/040-kuenstliche-welten/033-meilensteine-der-kuenstlichen-intelligenz.md)
