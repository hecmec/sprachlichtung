...
In diesem Video des YouTube-Kanals _Parole de philosophe_ erkunden wir das komplexe und innovative Denken von Gilles Deleuze, einem der bedeutendsten französischen Philosophen des 20. Jahrhunderts.
...
## **Strukturierte Zusammenfassung: Die Philosophie von Gilles Deleuze, eine schöpferische Revolution**
...
Herkömmlich teilt sich das menschliche Denken in zwei Pole:

- **Die Wissenschaft**: Sie erklärt die Welt durch Gesetze und rationale Beweisführung.
- **Die Kunst**: Sie drückt Gefühle und Sichtweisen aus, ohne etwas beweisen zu wollen.

**Problem**: Wo steht die Philosophie? Historisch stand sie stets auf der Seite der Wissenschaft und gab der Logik und der Argumentation den Vorzug. Deleuze aber **kehrt diese Perspektive um**: Die Philosophie ist keine Suche nach Wahrheit, sondern eine **Schöpfung von Begriffen**. Der Philosoph ist nicht länger ein Gelehrter, sondern ein **Künstler des Denkens**.
...
Für Deleuze ist ein Begriff keine bloße Idee und kein bloßes Wort. Er ist eine **eigenständige Konstruktion**, eine Erfindung, die **unsere Art zu sehen und zu leben verwandelt**. Philosophieren heißt nicht, nach der Wahrheit zu suchen, sondern **Werkzeuge zu schaffen, die das Dasein intensivieren**.

## **2. Die Philosophie als Bejahung des Lebens**

Deleuze knüpft an **Spinoza** (die Macht des Handelns) und **Nietzsche** (die Zerstörung der alten Begriffe) an, um zu behaupten, die Philosophie müsse **das Leben ins Denken übergehen lassen**. Das bedeutet:

- Sich zu weigern, die Wirklichkeit in Definitionen erstarren zu lassen.
- In den **Strom des Lebens** einzutauchen, um seiner Bewegung zu folgen.
- **An der Erschaffung der Welt teilzunehmen**, statt sie bloß zu kommentieren.

**Folge**: Das Denken wird zu einer **aktiven Kraft**, nicht zu einem bloßen Spiegel der Wirklichkeit.
...
**Lösung**: Die Philosophie soll uns helfen, diese Ströme zu **decodieren** und sie frei neu zu ordnen, ohne dem Wahnsinn zu verfallen. Sie wird zu einer **Lebenskunst**, zu einer Weise des **Werdens** statt des **Seins**.

## **4. Der Wunsch: eine Fabrik, kein Mangel**

Für Deleuze ist der Wunsch kein Mangel (wie in der Psychoanalyse), sondern eine **produktive Kraft**:
...
## **5. Denken wie ein Rhizom, nicht wie ein Baum**
...
Deleuze erfindet den Begriff des **Chaosmos** (Chaos + Kosmos):

- Der **Kosmos** ist nicht das Gegenteil des Chaos, sondern ein **vorläufiges Gefüge**, das der Unordnung abgerungen ist.
...
- Die Philosophie soll das Chaos nicht **bändigen**, sondern es **annehmen**, um daraus Schöpfung zu gewinnen.
- **Beispiel**: Ein Künstler schafft ein Werk aus dem Chaos; ein Philosoph erfindet einen Begriff, der in der Unbeständigkeit **standhält**.
...
- **Frei sein** heißt:
  ...
  - Mit den anderen, den Ideen, den Situationen zu **werden**, ohne alles beherrschen zu wollen.
  - Den eigenen Körper in einen **Durchgangsort** für die Wunschströme zu verwandeln.

**Konkretes Beispiel**:

- Die Liebe auf den ersten Blick ist keine Begegnung zweier Identitäten, sondern die Geburt eines **neuen Schaltkreises** zwischen zwei Wesen.
- Die Philosophie lehrt uns, auf diesen Strömen zu **surfen**, ohne sie festschreiben zu wollen.

## **Schluss: Die Philosophie als Lebenskunst**

Deleuze bestimmt die Philosophie neu als:

1. Eine **Schöpfung von Begriffen** (keine Erklärung).
2. Eine **Lebenskunst** (keine Theorie).
3. Eine **Bejahung des Chaos** (keine Flucht in die Ordnung).

**Vermächtnis**:

- Er lädt uns ein, **unsere Identitäten zu überschreiten**, um unerhörte **Werdensweisen** zu erkunden.
- Das Denken ist kein Werkzeug mehr, um die Welt zu verstehen, sondern eine **Kraft, sie neu zu erfinden**.

**Abschließende Frage**:
Und wenn Philosophieren vor allem hieße, **mit dem Chaos tanzen zu lernen**?
