...
* **Regeln/Merkmale:**
    ...
    * **Kompromiss und Verhandlung:** Das Ergebnis ist oft nicht "richtig" oder "falsch", sondern ein ausgehandelter Deal.
* **Beispiele:**
...
* **Heute:** Ein entscheidendes neues Feld ist das **digitale Sprachspiel** (Soziale Medien, Foren).
...
* **Welches Spiel spielen wir hier gerade?** (Wissenschaft, Politik, Kunst?)
* **Was ist das Ziel dieses Spiels?** (Wahrheit, Macht, sozialer Kitt?)
* **Nach welchen Regeln wird gespielt?**
* **Wird fair gespielt oder versucht jemand, die Regeln eines Spiels in einer anderen Arena anzuwenden?** (z. B. eine wissenschaftliche Frage mit politischen Argumenten "entscheiden" zu wollen).
