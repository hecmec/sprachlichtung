...
- 🇩🇪 [kritisches-denken-podcast.de](https://kritisches-denken-podcast.de/)
  - Über 100 Episoden sum Thema Kritisches Denken und Wissenschaft und wie sie Wissen schafft.
- 🇬🇧 [The Skeptics' Guide to the Universe](https://www.theskepticsguide.org/) (Steven Novella)
  - Wöchentlicher „reality check" gegen Pseudowissenschaft und Desinformation.
- 🇬🇧 [Rationally Speaking](http://rationallyspeakingpodcast.org/) (Julia Galef)
  - Gespräche an der Grenze zwischen Vernunft und Unsinn, Wissenschaft und Pseudowissenschaft.
- 🇫🇷 [Méta de Choc](https://metadechoc.fr/) (Élisabeth Feytit)
  - Kritisches Denken angewandt auf sich selbst: Glaube, Wissen und die Mechanismen der Überzeugung.
