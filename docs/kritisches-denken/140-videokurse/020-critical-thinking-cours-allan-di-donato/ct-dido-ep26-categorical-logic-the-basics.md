...
Mittelalterliche Logiker leiteten diese Buchstaben aus den lateinischen Wörtern **_affirmo_** („ich bejahe", was **A** und **I** ergibt) und **_nego_** („ich verneine", was **E** und **O** ergibt) ab.
...
[Article en français](pathname:///fr/docs/kritisches-denken/videokurse/critical-thinking-cours-allan-di-donato/ct-dido-ep26-categorical-logic-the-basics) | [Article in English](pathname:///en/docs/kritisches-denken/videokurse/critical-thinking-cours-allan-di-donato/ct-dido-ep26-categorical-logic-the-basics)
