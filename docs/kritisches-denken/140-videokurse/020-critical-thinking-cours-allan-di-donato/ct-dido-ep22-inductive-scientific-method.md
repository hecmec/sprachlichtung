...
controls src='https://youtu.be/ABWvccGyLhE' />
...
1. **Die Situation** — eine Situation entfacht ein theoretisches oder praktisches Problem oder eine Frage.
2. **Das Problem formulieren** — genau sein, was untersucht wird und wie (statistisch, experimentell, historisch).
3. **Beobachtung** — relevante Phänomene beobachten und aufzeichnen. (Eine philosophische Sorge: Theorie und Annahme bestimmen oft, was als beobachtbar gilt.)
4. **Reflexion** — auftretende Muster und einen möglichen **kausalen Mechanismus** identifizieren, gestützt auf **Hintergrundwissen**. Ein kausaler Mechanismus verbindet Ursache und Wirkung; ohne ihn sind Ereignisse bloß zufällig.
5. **Eine Hypothese formulieren** — das zentrale Merkmal, eine intelligente Vermutung. Dieser Schritt ist **abduktiv** (ein Sprung über die aktuelle Evidenz hinaus) und nutzt den **Schluss auf die beste Erklärung**.
6. **Vorhersagen machen** — wenn die Hypothese richtig ist, sollten bestimmte Dinge folgen (kein Sauerstoff, kein Feuer).
7. **Experimente durchführen** — wiederholen und beobachten. Ein vorhergesagtes Ereignis gibt eine **mögliche Bestätigung**, keinen Beweis; eine fehlgeschlagene Vorhersage bedeutet, dass die Hypothese wahrscheinlich falsch ist.
8. **Die Hypothese annehmen oder verwerfen** — beurteilt danach, wie konsistent die Ergebnisse auftreten. Grob: ~90 % Erfolg heißt, sie behalten, ~60 % erfordert weitere Untersuchung, unter ~40 % legt nahe, sie aufzugeben. Eine mit hoher Wahrscheinlichkeit bestätigte Hypothese wird zu einer **Theorie**; eine universell bestätigte Theorie wird zu einem **wissenschaftlichen Gesetz**.
...
[Article en français](/fr/docs/kritisches-denken/140-videokurse/020-critical-thinking-cours-allan-di-donato/ct-dido-ep22-inductive-scientific-method.md) | [Article in English](/en/docs/kritisches-denken/140-videokurse/020-critical-thinking-cours-allan-di-donato/ct-dido-ep22-inductive-scientific-method.md)
