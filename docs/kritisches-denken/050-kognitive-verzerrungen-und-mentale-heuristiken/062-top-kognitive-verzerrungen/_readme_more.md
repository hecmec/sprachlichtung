...
Mitglieder der eigenen Gruppe werden als vertrauenswürdiger, kompetenter oder sympathischer wahrgenommen
Erfolge der eigenen Gruppe werden stärker gewichtet
Fehler von Gruppenmitgliedern werden eher entschuldigt oder übersehen
Gleichzeitig werden andere Gruppen skeptischer oder kritischer betrachtet
Beispiele:

Sport: Fans sehen Fouls des eigenen Teams als weniger schwerwiegend an
Arbeitsplatz: Bevorzugung von Kollegen aus der eigenen Abteilung
Politik: Parteianhänger bewerten gleiche Handlungen je nach Partei unterschiedlich
Nationalität: "Wir Deutsche sind..." vs. kritischere Sicht auf andere Länder
...
Kernaspekte des Herdenverhaltens:

Imitation des Verhaltens anderer ohne eigene Analyse
Annahme, dass "die Masse" richtig liegt
Angst vor sozialer Ausgrenzung bei abweichendem Verhalten
Verlust der individuellen Urteilsfähigkeit in Gruppen
Verstärkung durch soziale Bestätigung
Beispiele:

Finanzmärkte: Börsenblasen und -crashs durch Massenpanik
Mode: Trends folgen, weil "alle es machen"
Soziale Medien: Viral gehende Inhalte und Challenges
Politik: Wählen der "wahrscheinlichen Sieger"
Konsumverhalten: Hamsterkäufe in Krisenzeiten
Restaurants: Wahl voller statt leerer Lokale
...
Die Vergangenheit als besser in Erinnerung behalten, als sie tatsächlich war
Die Zukunft pessimistischer einschätzen, als sie wahrscheinlich sein wird
Generell glauben, dass sich die Welt verschlechtert
Typische Aussagen:
...
Ältere Menschen erinnern sich an ihre Kindheit als idyllischer, obwohl es damals auch Probleme gab
Nostalgische Verklärung vergangener Jahrzehnte (z.B. "die goldenen 50er Jahre")
...
ernaspekte der Reaktanz:

Widerstand gegen wahrgenommene Kontrolle oder Zwang
Verstärkter Wunsch nach dem, was verboten oder eingeschränkt wird
Automatische Gegenwehr bei Einschränkung der Wahlfreiheit
Trotzreaktion gegen Bevormundung
Beispiele:

Verbote: Jugendliche rauchen eher, wenn es strikt verboten ist
Marketing: Aggressive Verkaufstaktiken führen zu Ablehnung
Politik: "Du musst XY wählen" führt zur Gegenwehr
...
Hast du schon einmal etwas gekauft oder eine Entscheidung getroffen, die dir im Nachhinein irrational erschien? Damit bist du nicht allein. Jeden Tag nutzt dein Gehirn mentale Abkürzungen, sogenannte kognitive Verzerrungen, um die Flut an Informationen zu verarbeiten, die auf dich einprasseln. Diese Abkürzungen sind zwar hilfreich, können uns aber auch in die Irre führen—vor allem, wenn es um unser Kaufverhalten geht.
