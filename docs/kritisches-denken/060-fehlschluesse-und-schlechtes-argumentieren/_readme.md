Fehlschlüsse, Paralogismus, Trugschluss, Scheinargument

# Klassification (ähnlich zu )
...
## Petitio Principii (zirkelhaft)

- Circulus vitiosus (Zirkelschluss, Gott - Bibel - Gott)
- Sprachzirkel
...
- Illitcit Major
- Argumentum ad logicam (Fallacy-Fallacy

## Irrelevante Prälissen

- Genetischer Fehlschluss (Die Krankenversicherung wurde von den Nazis erfunden, wie kannst du das richtig finden)
- Falsche Gründe (Du solltest nicht rauchen da Zigaretten radioaktiv sind)

## Irrelevante Appelle

- Argumentum ad Hominem
- Argumentum ad verecundiam (Authorität, Einstein hat gesagt)
...
- Strohmann (wir sollten Asylbewerber reinlassen, Will du das ganze Elend der Welt aufnehemen)
- Brunnenvergiftung (Als Mann, kannst du nicht über Abtreibung reden)
- Tu quoque (Rede nicht über trinken, du trinkst doch selber)
- Red Herring (Smokescreen, auf ein Nebenthema ablenken)
  - https://rationalwiki.org/wiki/Red_herring
  - Schon bei Aristoteles: Sophistische Widerlegungen
- Spott und Humor

## Sprachliche Verwechslungen - Vagheit - Ambiguität

- Äquivokation (Sie spielt mit dem Pferd, bevor sie ihn schach setzt.)
  [Beispiele äquivokation](https://denkfehler.online/lernmaterial/allgemein/mehrdeutigkeit/aequivokation)
- Mehrdeutigkeit (Er hasst seinen Vater wenn er trinkt, Volunteers needed to help torture survivors)
- Suggestive Anspielung (Fragen Sie ihn, wie er seine Wahlkampagne finanziert)
- Unterscheidung ohne Unterschied (Ich bin keine Rassist, ich hasse einfach Scharze. Ich habe an dem Joint gezogen aber nicht inhaliert, _Clinton_)
- Turm-und-Wall-Fehler (Motte-and-bailey, bewegtes Ziel)
- Haufen-paradox (Heap, Beard)
...
- Naturalistischer Fehlschluss (Ist-Soll-Fehlschluss, is ought, Ethik)
- Wunschdenken (Leben nach dem Tode)
- Missbrauch eines Prinzips (Ich darf auf meinem Grund machen was ich will)
- Fehlerhafte Analogie / Vergleich (Rauchen und Arsen, Whataboutism)
...
- Accident (A dicto simpliciter ad dictum secundum quid, Alle Vögel können fliegen, Pinguine können also fliegen)
- Cherry picking
- Falsche Analogie
- Hastische Verallgemeinerung
- No true Scotsman

## Mangelde Belege

- Unzureichende Stichprobe (ich war einmal verheiratet, das war mir genug)
- Nicht-repräsentative Daten
- Argumentum ad ignorantiam (Appeal to ignorance, Umtausch der Beweislast. Man kann nicht zeigen das es keine Geister, Feen oder Elfen gibt. )
- Kontrafaktisches Konditional (Hättest du es probiert ...)
- Forderung nach einem Privileg (special pleading)
- Gott-der-Lücken-Argument (Divine fallacy, argument from incredulity)
- Persönliche Skepsis

## Kausale Fehlschlüsse

- Verwechslung notwendiger und hinreichender Bedingungen
...
- Red Herrings (type of fallacy of relevance, Smoke Screen, Ablenkungs­fehlschlüsse)
...
- [RationalWiki](https://rationalwiki.org/wiki/Logical_fallacy)
...
- [YouTube Video, The Paint Explainer: Logical Fallacy Explained in 11 Minutes](https://www.youtube.com/watch?v=pCg-SNOteQQ)
  - die bekanntesten 60 oder so Fehlschlüsse, nur mal aufgelistet, absichtlich sehr oberflächlich gehalten.
